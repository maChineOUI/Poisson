...
/* ** argv: Valeur des arguments */
{
  ...
  T1=20.0;           /* Dirichlet boundary condition at x=1 */
  ...
  write_vec(RHS, &la, "/app/results/RHS_direct.dat");
  write_vec(EX_SOL, &la, "/app/results/EX_SOL_direct.dat");
  write_vec(X, &la, "/app/results/X_grid_direct.dat");
  ...
  write_GB_operator_colMajor_poisson1D(AB, &lab, &la, "/app/results/AB_direct.dat");
  ...
  write_GB_operator_colMajor_poisson1D(AB, &lab, &la, "/app/results/LU_direct.dat");
  write_xy(RHS, X, &la, "/app/results/SOL_direct.dat");
